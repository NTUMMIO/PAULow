...
os.makedirs( "Use_Model/processing_area/temp_crop", exist_ok = True )
os.makedirs( "Use_Model/processing_area/temp_mask", exist_ok = True )
os.makedirs( "Use_Model/processing_area/temp_stack", exist_ok = True )
os.makedirs( "Use_Model/processing_area/temp_stack_mask", exist_ok = True )
